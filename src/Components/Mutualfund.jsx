...
const Mutualfund = () => {
  ...
  <br />
  📞 <a href="tel:+919898488243" className="text-blue-800 underline">Contact Now</a>
</div>


          {/* MF Scheme Banner Section */}
          <div className="mt-12 md:pl-16 px-8 md:px-0">
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">
              🖼️ Featured Mutual Fund Schemes
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <img src={Scheme1} alt="Scheme 1" className="w-full h-[250px] object-cover rounded-xl shadow-md" />
              <img src={Scheme2} alt="Scheme 2" className="w-full h-[250px] object-cover rounded-xl shadow-md" />
              <img src={Scheme3} alt="Scheme 3" className="w-full h-[250px] object-cover rounded-xl shadow-md" />
